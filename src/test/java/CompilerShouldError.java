 ...
 */
public class CompilerShouldError extends CompilerShouldAbstract {
    ...
    @Test
    public void giveInformativeLackOfParenthesisMessage() throws Exception {
        runCompiler("( 3 * 2");
        assertErrorContains("Line 1 at position 7 mismatched input 'the end of the source code' expecting ')'");
    }

    @Test
    public void giveInformativeToManyOfParenthesisMessage() throws Exception {
    ...
    @Test
    public void giveInformativeToManyOfParenthesisMessage2() throws Exception {
